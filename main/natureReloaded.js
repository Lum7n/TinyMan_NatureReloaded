...
(function (NatureReloaded) {
    ...
    //all audio clips 
    let prologue1Q = new Audio("./audios/S1_Frage1.mp3");
    let prologueAnswerYes = new Audio("./audios/S1_Reaktion_ja.mp3");
    let prologueAnswerNo = new Audio("./audios/S1_Reaktion_nein.mp3");
    let prologue2 = new Audio("./audios/S1_Outro.mp3");
    let scene2Q = new Audio("./audios/S2_s_Frage2.mp3");
    let scene2AnswerYes = new Audio("./audios/S2_s_Reaktion_ja.mp3");
    let scene2AnswerNo = new Audio("./audios/S2_s_Reaktion_nein.mp3");
    let scene3Q1 = new Audio("./audios/S3_s_Frage3.mp3");
    let scene3PositiveVQ2 = new Audio("./audios/S3_s_Frage4_positiv.mp3");
    let scene3NegativeVQ2 = new Audio("./audios/S3_s_Frage4_negativ.mp3");
    let scene3BothVQ2 = new Audio("./audios/S3_s_Frage4_neutral.mp3");
    let scene3AnswerYes = new Audio("./audios/S3_s_Reaktion_ja.mp3");
    let scene3AnswerNo = new Audio("./audios/S3_s_Reaktion_nein.mp3");
