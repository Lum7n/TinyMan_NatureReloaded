...
(function (NatureReloaded) {
    ...
    let prologueAnswerNo = new Audio("./audios/S1_Reaktion_nein.wav");
    let prologue2 = new Audio("./audios/S1_Outro.wav");
    let scene2Q = new Audio("./audios/S2_s_Frage2.wav");
    let scene2AnswerYes = new Audio("./audios/S2_s_Reaktion_ja.wav");
    let scene2AnswerNo = new Audio("./audios/S2_s_Reaktion_nein.wav");
    let scene3Q1 = new Audio("./audios/S3_s_Frage3.wav");
    let scene3PositiveVQ2 = new Audio("./audios/S3_s_Frage4_positiv.wav");
    let scene3NegativeVQ2 = new Audio("./audios/S3_s_Frage4_negativ.wav");
